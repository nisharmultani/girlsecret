...
const footerNavigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=61583184296845',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/girlsecretuk',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'Pinterest',
      href: 'https://uk.pinterest.com/girlsecretuk/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} GirlSecret. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
